...
extern void F979_7342(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F979_7343(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F979_7344(EIF_REFERENCE);
extern EIF_TYPED_VALUE F979_7345(EIF_REFERENCE);
extern EIF_TYPED_VALUE F979_7346(EIF_REFERENCE);
...
void F979_7342 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 978, Current, 0, 2, 13578);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(978, Current, 13578);
...
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5149, 0xF8000101, 0); /* case */
	RTAR(Current, arg2);
	...
	*(EIF_REFERENCE *)(Current + RTWA(5145, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5147, 0xF80000E7, 0); /* violation_tag */
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5147, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 5151, 0xF80000E7, 0); /* expected_tag_name */
...
void F979_7343 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 978, Current, 0, 3, 13579);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(978, Current, 13579);
	RTCC(arg1, 978, l_feature_name, 1, eif_new_type(231, 0x01), 0x01);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,257,0xFF01,0xFFF9,0,185,0xFFFF};
		EIF_TYPE typres0;
...
body:;
	...
	*(EIF_REFERENCE *)(Current + RTWA(5147, dtype)) = (EIF_REFERENCE) tr1;
	...
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5151, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(7);
	RTDBGAA(Current, dtype, 5146, 0xF80000E7, 0); /* bookmark_name */
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
...
void F979_7344 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 978, Current, 3, 0, 13580);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(978, Current, 13580);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 5143, 0x04000000, 1); /* passed */
	...
	ur1 = RTCCL(tr1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5151, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur2 = RTCCL(tr2);
	...
	if (tb1) {
		...
		*(EIF_BOOLEAN *)(Current + RTWA(5143, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		...
		RTHOOK(7);
		RTDBGAA(Current, dtype, 5144, 0x04000000, 1); /* contract_violated */
		*(EIF_BOOLEAN *)(Current + RTWA(5144, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		RTHOOK(8);
		RTCT0(NULL, EX_CHECK);
		...
		*(EIF_REFERENCE *)(Current + RTWA(5147, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(10);
		RTDBGAA(Current, dtype, 5148, 0x10000000, 1); /* violation_type */
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1240, dtype))(Current)).it_i4);
		*(EIF_INTEGER_32 *)(Current + RTWA(5148, dtype)) = (EIF_INTEGER_32) ti4_1;
	}
	RTHOOK(11);
...
EIF_TYPED_VALUE F979_7345 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 978, Current, 0, 0, 13581);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F979_7346 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
