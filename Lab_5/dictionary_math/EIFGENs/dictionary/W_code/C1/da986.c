...
extern void F986_7493(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F986_7498(EIF_REFERENCE);
extern EIF_TYPED_VALUE F986_7499(EIF_REFERENCE);
...
extern void F986_7506(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 13730);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 13730);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 13731);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 13731);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5245, dtype));
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 13732);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 13732);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5245, dtype));
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 13733);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 13733);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 1, 3, 13735);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 13735);
	RTIV(Current, RTAL);
...
/* {DATE_VALUE}.set_day */
void F986_7493 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 1, 1, 13736);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 13736);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("d_large_enough", EX_PRE);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 1, 1, 13737);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 13737);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("m_large_enough", EX_PRE);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 1, 1, 13738);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 0, 1, 13739);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 13739);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ui4_1 = arg1;
...
void F986_7498 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 1, 0, 13741);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {DATE_VALUE}.day_mask */
EIF_TYPED_VALUE F986_7499 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
{
	GTCX
	RTOTC (F986_7505,13729,RTMS_EX_H("compact_date",12,1114629989));
}

/* {DATE_VALUE}.set_private_internal_compact_date */
void F986_7506 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_3 ui4_3x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 0, 1, 13729);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 13729);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ui4_1 = ((EIF_INTEGER_32) 65535L);
