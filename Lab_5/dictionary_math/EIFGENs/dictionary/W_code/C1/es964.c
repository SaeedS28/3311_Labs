...
extern void F964_7159(EIF_REFERENCE);
extern void F964_7160(EIF_REFERENCE);
extern void F964_7161(EIF_REFERENCE);
extern void F964_7162(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F964_7163(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F964_7165(EIF_REFERENCE);
extern void F964_7166(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F964_7167(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F964_7168(EIF_REFERENCE);
extern EIF_TYPED_VALUE F964_7169(EIF_REFERENCE);
extern void F964_7172(EIF_REFERENCE);
extern EIF_TYPED_VALUE F964_7173(EIF_REFERENCE);
extern EIF_TYPED_VALUE F964_7174(EIF_REFERENCE);
extern EIF_TYPED_VALUE F964_7175(EIF_REFERENCE);
extern EIF_TYPED_VALUE F964_7176(EIF_REFERENCE);
extern EIF_TYPED_VALUE F964_7177(EIF_REFERENCE);
...
void F964_7159 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 963, Current, 1, 0, 13432);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((EIF_BOOLEAN) !loc1) {
		...
		RTHOOK(3);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(4996, dtype))(Current);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTE_E
...
void F964_7160 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 5000, 0x04000000, 1); /* show_err */
	*(EIF_BOOLEAN *)(Current + RTWA(5000, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F964_7161 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13418);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(963, Current, 13418);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 5001, 0x04000000, 1); /* browser */
	*(EIF_BOOLEAN *)(Current + RTWA(5001, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 963, Current, 0, 1, 13419);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(963, Current, 13419);
	RTCC(arg1, 963, l_feature_name, 1, eif_new_type(231, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 4997, 0xF80000E7, 0); /* default_html_name */
	RTAR(Current, arg1);
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 963, Current, 0, 1, 13420);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	...
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 5000, 0x04000000, 1); /* show_err */
	*(EIF_BOOLEAN *)(Current + RTWA(5000, Dtype(Current))) = (EIF_BOOLEAN) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F964_7165 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 963, Current, 0, 1, 13422);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	...
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4991, Dtype(Current)))(Current, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F964_7167 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 963, Current, 0, 1, 13423);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	if (tb1) {
		...
		if (tb1) {
			...
			tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4993, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
			ur1 = RTCCL(tr3);
			...
			if (tb1) {
				...
				ur1 = tr3;
				tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4634, "plus", tr2))(tr2, ur1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
				tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4993, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
				ur1 = RTCCL(tr2);
				tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4634, "plus", tr3))(tr3, ur1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
				tr3 = RTMS_EX_H("\'",1,39);
				ur1 = tr3;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 963, Current, 1, 0, 13425);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 963, Current, 6, 0, 13426);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4995, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(2);
	RTDBGAL(Current, 2, 0xF800011C, 0, 0); /* loc2 */
	loc2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4994, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(3);
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4991, dtype))(Current, ur1x);
	RTHOOK(16);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(4998, dtype));
...
EIF_TYPED_VALUE F964_7173 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F964_7174 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(4998,Dtype(Current)));
	return r;
}


/* {ES_TESTABLE}.number_passed_tests */
EIF_TYPED_VALUE F964_7175 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F964_7176 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
/* {ES_TESTABLE}.browser */
EIF_TYPED_VALUE F964_7177 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
