...
extern void F980_7342(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F980_7343(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 979, Current, 0, 2, 13577);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(979, Current, 13577);
...
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5143, 0xF80000FF, 0); /* case */
	RTAR(Current, arg2);
	...
	*(EIF_REFERENCE *)(Current + RTWA(5141, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 5145, 0xF80000E7, 0); /* expected_tag_name */
...
void F980_7342 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 979, Current, 0, 3, 13578);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(979, Current, 13578);
	RTCC(arg1, 979, l_feature_name, 1, eif_new_type(231, 0x01), 0x01);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,255,0xFF01,0xFFF9,0,185,0xFFFF};
		EIF_TYPE typres0;
...
void F980_7343 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 979, Current, 3, 0, 13579);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(979, Current, 13579);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
		...
		*(EIF_BOOLEAN *)(Current + RTWA(5137, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	}
	RTVI(Current, RTAL);
	RTRS;
	RTE_E
...
EIF_TYPED_VALUE F980_7344 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 979, Current, 0, 0, 13580);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(979, Current, 13580);
	RTIV(Current, RTAL);
	RTHOOK(1);
