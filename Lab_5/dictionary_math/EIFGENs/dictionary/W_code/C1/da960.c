...
extern EIF_TYPED_VALUE F960_7114(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_7115(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_7116(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_7117(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_7118(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F960_7113,13379,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F960_7114)
EIF_TYPED_VALUE F960_7114 (EIF_REFERENCE Current)
{
	GTCX
...
RTOID (F960_7115)
EIF_TYPED_VALUE F960_7115 (EIF_REFERENCE Current)
{
	GTCX
...
RTOID (F960_7116)
EIF_TYPED_VALUE F960_7116 (EIF_REFERENCE Current)
{
	GTCX
...
RTOID (F960_7117)
EIF_TYPED_VALUE F960_7117 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F960_7118 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F960_7118,13384,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F960_7119,13385,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F960_7120,13386,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit960 (void)
{
	GTCX
	RTOTS (7113,F960_7113)
	RTOTS (7114,F960_7114)
	RTOTS (7115,F960_7115)
	RTOTS (7116,F960_7116)
	RTOTS (7117,F960_7117)
	RTOTS (7118,F960_7118)
	RTOTS (7119,F960_7119)
	RTOTS (7120,F960_7120)
}
