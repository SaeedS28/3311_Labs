/*
 * Code for class COMMAND_MOVE_UP
 */
...
extern void F998_7459(EIF_REFERENCE);
extern void F998_7460(EIF_REFERENCE);
extern void F998_7461(EIF_REFERENCE);
...
/* {COMMAND_MOVE_UP}.execute */
void F998_7459 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 13704);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 13704);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ui4_2 = ti4_2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(4960, "move_up", tr1))(tr1, ui4_1x, ui4_2x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
/* {COMMAND_MOVE_UP}.undo */
void F998_7460 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 13705);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 13705);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {COMMAND_MOVE_UP}.redo */
void F998_7461 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 13706);
	RTSA(Dtype(Current));
	RTSC;
