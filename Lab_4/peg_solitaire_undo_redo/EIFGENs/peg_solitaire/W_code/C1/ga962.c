...
extern void F962_7839(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 13413);
	RTSA(Dtype(Current));
	RTSC;
...
void F962_7839 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 961, Current, 0, 7838);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT(NULL, Current);
