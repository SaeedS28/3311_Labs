...
extern void F959_7108(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F959_7113(EIF_REFERENCE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 4939, 0xF8000112, 0); /* history */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,245,0xFF01,996,0xFFFF};
		EIF_TYPE typres0;
...
void F959_7108 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 958, Current, 0, 1, 13381);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(958, Current, 13381);
	RTCC(arg1, 958, l_feature_name, 1, eif_new_type(996, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 958, Current, 1, 0, 13382);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 4940, 0x10000000, 1); /* position */
	ti4_1 = *(EIF_INTEGER_32 *)(loc1 + RTVA(3132, "index", loc1));
	*(EIF_INTEGER_32 *)(Current + RTWA(4940, dtype)) = (EIF_INTEGER_32) ti4_1;
	for (;;) {
		RTHOOK(3);
		ti4_1 = *(EIF_INTEGER_32 *)(loc1 + RTVA(3132, "index", loc1));
		...
		RTHOOK(4);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(2704, "remove_right", loc1))(loc1);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
...
/* {HISTORY}.back */
void F959_7113 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 958, Current, 0, 0, 13387);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 958, Current, 0, 0, 13388);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
