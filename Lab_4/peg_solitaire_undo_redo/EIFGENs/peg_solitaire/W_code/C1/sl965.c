...
extern EIF_TYPED_VALUE F965_7158(EIF_REFERENCE);
extern void F965_7841(EIF_REFERENCE, int);
...
RTOID (F965_7158)
EIF_TYPED_VALUE F965_7158 (EIF_REFERENCE Current)
{
	GTCX
...
void F965_7841 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 964, Current, 0, 7840);
	RTSA(dtype);
	RTME(dtype, 0);
...
{
	GTCX
	RTOTS (7156,F965_7156)
	RTOTS (7157,F965_7157)
	RTOTS (7158,F965_7158)
}
