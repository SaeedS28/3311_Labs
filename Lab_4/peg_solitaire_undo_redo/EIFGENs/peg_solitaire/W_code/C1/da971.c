...
extern EIF_TYPED_VALUE F971_7219(EIF_REFERENCE);
extern EIF_TYPED_VALUE F971_7220(EIF_REFERENCE);
extern EIF_TYPED_VALUE F971_7221(EIF_REFERENCE);
extern EIF_TYPED_VALUE F971_7222(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F971_7215,13493,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 970, Current, 0, 0, 13494);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 970, Current, 0, 0, 13495);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
RTOID (F971_7219)
EIF_TYPED_VALUE F971_7219 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F971_7220 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F971_7220,13498,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F971_7221 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F971_7221,13499,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F971_7222 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F971_7222,13500,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit971 (void)
{
	GTCX
	RTOTS (7215,F971_7215)
	RTOTS (7216,F971_7216)
	RTOTS (7217,F971_7217)
	RTOTS (7218,F971_7218)
	RTOTS (7219,F971_7219)
	RTOTS (7220,F971_7220)
	RTOTS (7221,F971_7221)
	RTOTS (7222,F971_7222)
}
