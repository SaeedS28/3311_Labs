...
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5126, "test", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_SOLITAIRE_UI test_redo */
EIF_TYPED_VALUE _A977_78 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5127, "test_redo", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_SOLITAIRE_UI test_redo_empty */
EIF_TYPED_VALUE _A977_79 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5128, "test_redo_empty", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_SOLITAIRE_UI test_undo_empty */
EIF_TYPED_VALUE _A977_80 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5129, "test_undo_empty", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_SOLITAIRE_UI test_multiple_undo */
EIF_TYPED_VALUE _A977_81 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5130, "test_multiple_undo", closed [1].it_r))(closed [1].it_r);
}
